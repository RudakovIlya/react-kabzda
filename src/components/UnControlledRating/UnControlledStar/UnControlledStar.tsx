...
export type UnControlledValuesType = 0 | 1 | 2 | 3 | 4 | 5

export type UnControlledStarPropsType = {
    selected: boolean
    values: UnControlledValuesType
    onClick: (value: UnControlledValuesType) => void
}

const UnControlledStar: React.FC<UnControlledStarPropsType> = ({selected, values, onClick}) => {
